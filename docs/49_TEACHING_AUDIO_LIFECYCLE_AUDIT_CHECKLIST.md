...
状态：`formal_work_order_active / AUDIO_A_dispatched / AUDIO_B_C_waiting / blocks_LP03_dispatch / media_locked`
...
`overhaul-344a-p3` 已建立共享受控播放句柄、迁移 LS08 与 C4-01，并在提交 `8cea6d46b725c26d2c8272086eab56b271750b18` 通过主管独立审查。本工作单现为 LP03 之前唯一运行工作；固定先做 `AUDIO-A`，通过并冻结后才做 `AUDIO-B`，再做 `AUDIO-C`。不得与 LP03、C4-R01、美术、视频、语音或新课程合并。
