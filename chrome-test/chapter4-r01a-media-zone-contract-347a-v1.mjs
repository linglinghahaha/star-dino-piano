...
const core = { coordinateContractId: "chapter4-r01a-browser-scheduler-zones-overhaul-347a-v1", prototypeBaseline: "overhaul-347a-c4-r01a", buildIdentity: "overhaul-347a-c4-r01a", runtimeIntegrationAllowed: false, deviceValidation: "missing", captureScope, expectedPairs, expectedCaptureCount: expectedPairs.length, actualCaptureCount, expectedStates: states, sourceFiles: ["chrome-test/chapter4-r01a-media-zone-contract-347a-v1.mjs", "chrome-test/chapter4-r01a-audio-lifecycle-check.mjs", "app.js", "index.html", "chapter4-slice.css"].map(sourceFile), viewports: records, failures, browserErrors };
