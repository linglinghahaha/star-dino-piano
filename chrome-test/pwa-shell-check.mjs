...
try {
  ...
  const cacheInventory = await page.evaluate(async () => {
    ...
    const cacheName = cacheNames.find((name) => name === "star-dino-pwa-overhaul-340d-v1") || "";
  ...
  record(
    ...
    cacheInventory.controlled && cacheInventory.cacheName === "star-dino-pwa-overhaul-340d-v1" &&
