...
const outputPath = process.argv[3] || "docs/30_CHAPTER3_MEDIA_ZONE_CONTRACT_340D.json";
const screenshotDir = process.argv[4] || "screenshots/chapter3_media_zones_340d";
...
const sourcePaths = [
  "chrome-test/chapter3-media-zone-contract-340d.mjs",
  "index.html",
  "app.js",
  "styles.css",
...
try {
  for (const spec of viewports) {
    ...
    reducedPage.setDefaultTimeout(12000);
...
const contract = {
  ...
  coordinateContractId: "chapter3-media-zones-overhaul-340d-v1",
  contractSha256: null,
