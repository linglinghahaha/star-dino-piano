...
const outputPath = process.argv[3] || "docs/30_TEACHING_ZONE_COORDINATE_CONTRACT_340A.json";
const screenshotPrefix = process.argv[4] || "screenshots/teaching_zones_340a";
...
const contract = {
  ...
  coordinateContractId: "teaching-zones-overhaul-340c-v1",
  contractSha256: null,
