...
const outputPath = process.argv[3] || "docs/30_CHAPTER3_MEDIA_ZONE_CONTRACT_340C.json";
const screenshotDir = process.argv[4] || "screenshots/chapter3_media_zones_340c";
...
const sourcePaths = [
  "chrome-test/chapter3-media-zone-contract-340c.mjs",
  "index.html",
  "app.js",
  "styles.css",
