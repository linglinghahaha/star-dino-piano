...
const outputPath = process.argv[3] || "docs/30_CHAPTER3_LS08_MEDIA_ZONE_CONTRACT_343A_V1.json";
const screenshotDir = process.argv[4] || "screenshots/chapter3_ls08_media_zones_343a_v1";
...
const sourcePaths = ["chrome-test/chapter3-ls08-media-zone-contract-343a-v1.mjs", "index.html", "app.js", "styles.css", "keyboard-overrides.css", "map-overrides.css", "current-overhaul.css", "chapter3-visible.css"];
const failures = [];
const browserErrors = [];
...
function url() { const value = new URL(rootUrl); value.search = "?screen=map&check=chapter3-ls08-media-zones-343a-v1"; return value.toString(); }
...
const core = {
  coordinateContractId: "chapter3-ls08-media-zones-overhaul-343a-v1",
  prototypeBaseline: "overhaul-343a",
  buildIdentity: "overhaul-343a-p1",
