...
const outputPath = process.argv[3] || "docs/30_CHAPTER3_MEDIA_ZONE_CONTRACT_344A_V1.json";
const screenshotDir = process.argv[4] || "screenshots/chapter3_media_zones_344a_v1";
...
const sourcePaths = [
  "chrome-test/chapter3-media-zone-contract-344a-v1.mjs",
  "index.html",
  "app.js",
  "styles.css",
...
function url(search = "?screen=map&check=chapter3-media-zones-344a-v1") {
...
function fixture() {
  return {
    version: 1,
    active: null,
    history: canonicalC1C2History({ completedAt: "2026-07-11T01:00:00.000Z", tag: "chapter3-zones" }),
    lastRest: null,
    chapter3: {
...
const contract = {
  ...
  coordinateContractId: "chapter3-media-zones-overhaul-344a-v1",
  contractSha256: null,
