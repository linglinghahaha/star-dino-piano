...
const outputPath = process.argv[3] || "docs/30_CHAPTER3_LS08_MEDIA_ZONE_CONTRACT_344A_V3.json";
const screenshotDir = process.argv[4] || "screenshots/chapter3_ls08_media_zones_344a_v3";
...
const sourcePaths = ["chrome-test/chapter3-ls08-media-zone-contract-344a-v3.mjs", "index.html", "app.js", "styles.css", "keyboard-overrides.css", "map-overrides.css", "current-overhaul.css", "chapter3-visible.css"];
const failures = [];
const browserErrors = [];
...
function url() { const value = new URL(rootUrl); value.search = "?screen=map&check=chapter3-ls08-media-zones-344a-v3"; return value.toString(); }
...
const core = {
  coordinateContractId: "chapter3-ls08-media-zones-overhaul-344a-v3",
